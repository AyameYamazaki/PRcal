...
setting <- data.frame(fileno, Rolling_threshold, tor_timelimit, eye)
...
write.xlsx(output_list, paste("caloric_result_SPEVtor_", which_side, ".xlsx", sep=""))

pdf(paste("caloric_torplot", which_side, ".pdf", sep=""),  width = 15, height = 10)
print(tor_plot)
print(SPEVtor_plot)
dev.off()
