...
write.xlsx(output_list, paste("LP_averagex_TT_result_", id, "7.27.xlsx", sep=""), overwrite=TRUE)


pdf(paste("LP_averagex_bothTT_result_", id, "7.27.pdf", sep=""), width = 10, height = 5)
plot_averagex_right
plot_averagex_controladj_right
plot_averagex_left
plot_averagex_controladj_left
