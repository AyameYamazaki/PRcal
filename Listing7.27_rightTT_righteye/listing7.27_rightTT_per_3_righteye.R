...
data <- read.csv("turntable_per_9pt_right_3.csv") #csvファイルを読み込む make sure it is a control file! **********************
...
write.xlsx(output_list, paste("result_turntable_per_9pt_right_3.xlsx", sep = ""), overwrite = TRUE)

pdf(paste("2dplots_turntable_per_9pt_right_3.pdf", sep = ""), width = 10, height = 10)
yx_b <- ggplot()+
...
pdf(paste("rawplot_turntable_per_9pt_right_3.pdf", sep = ""), width = 10, height = 10)
plot_eyerayx
plot_eyerayy
plot_eyerayz
plot_torsion
...
pdf(paste("3dplots_turntable_per_9pt_right_3.pdf", sep = ""), width = 10, height = 10)
