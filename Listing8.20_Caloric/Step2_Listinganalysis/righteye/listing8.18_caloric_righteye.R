...
fileno = 21      #ここでファイル番号を適宜へんこうしていく。出力される結果もこの番号になる。
...
highpass=5*sd(torsion, na.rm=TRUE)  #change the passband if still noisy***************************************************************************
lowpass= -5*sd(torsion, na.rm=TRUE)  #change the passband if noisy***************************************************************************
