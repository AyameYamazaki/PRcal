...
#change the below parameters according to the data file!!!!!!!!!!!!!! change to right post accordingly
which_side = "left"
...
#Use this script for 30ND leftper and rightpost, 30NU rightper and leftpost and 60NU rightper and leftpost, although check the raw data before determining which side, as some subjects exhibit inversion with 30NU
...
setting <- data.frame(Rolling_threshold, tor_timelimit, eye)

library(openxlsx)
output_list <- list("Average_SPEVtor"=Average_SPEVtor, "top3_SPEVtor"=result_SPEVtor, "All_SPEVtor"=tor.sorted.data)
