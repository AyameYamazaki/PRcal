...
pdf(paste("1ptcaloric_Z_plot",  which_side, "_", pre_post, ".pdf", sep=""),  width = 15, height = 10)
print(Z_plot)
dev.off()


output_list <- list("Z_data"=NR_eyerays, "setting"=setting)
write.xlsx(output_list, paste("1ptcaloric_Z_result_",  which_side, "_", pre_post, ".xlsx", sep=""))
